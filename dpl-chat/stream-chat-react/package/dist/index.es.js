  ...
  function MessageSimple() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderStatus", function () {
      ...
      if (message.status === 'sending') {
        ...
        }, React__default.createElement(Tooltip, null, React__default.createElement(FormattedMessage, {
          id: "message.status.sending",
          defaultMessage: "Sending..."
        })), React__default.createElement(LoadingIndicator$1, null));
  ...
  _createClass(Message, [{
    ...
    value: function render() {
      ...
      return (//Give all Messages a id to scroll to
        ...
        }, React__default.createElement(Component$$1, _extends({}, this.props, {
          actionsEnabled: actionsEnabled,
          Message: this,
...
function (_PureComponent) {
  ...
  _createClass(ChannelHeader, [{
    ...
    value: function render() {
      ...
      }, !this.props.live && this.props.channel.data.member_count > 0 && React__default.createElement(React__default.Fragment, null, React__default.createElement(FormattedMessage, {
...
_defineProperty(ChannelHeader, "defaultProps", {
  ...
  _createClass(ChatDown, [{
    ...
    value: function render() {
      ...
      return React__default.createElement("div", {
        ...
        src: image
      }), React__default.createElement("h1", null, React__default.createElement(FormattedMessage, {
        id: "chat_down.connection_error",
        defaultMessage: "Connection Error"
      })), React__default.createElement("h3", null, React__default.createElement(FormattedMessage, {
...
function (_React$PureComponent) {
  ...
  _createClass(MessageLivestream, [{
    ...
    value: function render() {
      ...
      }, "O", React__default.createElement(FormattedMessage, {
...
export { Avatar, Message, MessageList, Chat, Channel, ChannelHeader, MessageInput, MessageInputLarge, MessageInputFlat, MessageInputSmall, Attachment, ChannelSearch, ChannelList, ChannelListMessenger, ChannelListTeam, ChannelPreviewCompact, ChannelPreviewMessenger, LoadMorePaginator, LoadingChannels, InfiniteScrollPaginator, LoadingIndicator$1 as LoadingIndicator, MessageCommerce, MessageLivestream, MessageTeam, MessageSimple, EventComponent, SendButton, Thread, TypingIndicator, Window, ReactionSelector, ReactionsList, ChatAutoComplete, emojiSetDef, commonEmoji, defaultMinimalEmojis, emojiData, isOnlyEmojis, isPromise, byDate, formatTypingArray, formatStatusArray, renderText, generateRandomId, smartRender, MESSAGE_ACTIONS, languageChangedEventName, languageChangedEvent, ChatContext, withChatContext, ChannelContext, withChannelContext };
