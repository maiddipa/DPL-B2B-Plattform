...
INNER JOIN (
	...
	from [BY4G6PYS].[OlmaDbProd].[dbo].LoadingLocations L JOIN OPENQUERY([BY4G6PYS], 'SELECT Id, RefLmsAddressNumber FROM [OlmaDbProd].[dbo].Addresses') A ON A.Id = L.AddressId
