...
UNION
SELECT Account_ID,'03' as O,Article,'Unabgestimmte ' + AccountDirection,SUM(Records),SUM(Intact),SUM(Defect) FROM @T1 WHERE BookingState = 'Unabgestimmt' OR BookingState = 'InAbstimmung'
GROUP BY Account_ID,Article,AccountDirection 
UNION
