...
namespace Dpl.B2b.Dal.Migrations
{
    ...
    [Migration("20200915144731_MakeVoucherTypeToExpressCodeModelNullable")]
    partial class MakeVoucherTypeToExpressCodeModelNullable
    {
            ...
            modelBuilder.Entity("Dpl.B2b.Dal.Models.AccountingRecordType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 56,
                            Description = "Digitale Pooling Gutschrift",
                            Name = "Digitale Pooling Gutschrift",
                            RefLtmBookingTypeId = "DPLDPG"
                        });
                });
