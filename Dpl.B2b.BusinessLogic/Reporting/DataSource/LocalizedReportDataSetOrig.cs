...
namespace Dpl.B2b.BusinessLogic.Reporting.DataSource
{
    partial class LocalizedReportDataSetOrig
    {
        ...
        public partial class PoolingVoucherRow
        {
            public string BarcodeContent => Number;
            public string BarcodeNumberContent => Number;
            public string BarcodeCustomerNumberContent => CustomerNumber;
        }

        public partial class PalletAcceptanceSlipRow
        {
            public string BarcodeContent => Number;
            public string BarcodeNumberContent => Number;
            public string BarcodeCustomerNumberContent => CustomerNumber;
        ...
        public partial class PalletAcceptanceVoucherlessRow
        {
            public string BarcodeContent => Number;
            public string BarcodeNumberContent => Number;
            public string BarcodeCustomerNumberContent => CustomerNumber;
