...
namespace Dpl.B2b.BusinessLogic.Rules.TransportOfferings.AcceptBid
{
    public class StateValidRule : BaseValidationWithServiceProviderRule<StateValidRule, StateValidRule.ContextModel>
    {
        ...
        protected override void EvaluateInternal()
        {
            ...
            rulesEvaluator.Eval(Context.Rules.InStateRequested);
        ...
        public class RulesBundle
        {
            ...
            {
                InStateRequested = new ValidOperatorRule<ContextModel>(
                    context, 
                    (c) => c.Transport.Status == Olma.TransportStatus.Requested, 
                    new AcceptingBidFailedMustBeRequested(), 
                    rule);
            }

            public readonly ValidOperatorRule<ContextModel> InStateRequested;
        }
