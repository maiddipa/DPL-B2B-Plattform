...
namespace Dpl.B2b.BusinessLogic.Rules.TransportOfferings.DeclineTransport
{
    public class StateValidRule : BaseValidationWithServiceProviderRule<StateValidRule, StateValidRule.ContextModel>
    {
        ...
        protected override void EvaluateInternal()
        {
            ...
            rulesEvaluator.Eval(Context.Rules.IsAllocated);
        ...
        public class RulesBundle
        {
            ...
            {
                IsAllocated = new ValidOperatorRule<ContextModel>(
                    context, 
                    (c) => c.Transport.Status == Olma.TransportStatus.Allocated, 
                    new DeclineTransportFailedMustBeAllocated(), 
                    rule);
                
               
            }

            public readonly ValidOperatorRule<ContextModel> IsAllocated;
