...
namespace Dpl.B2b.BusinessLogic.Rules.Organization.Update
{
    public class MainRule : BaseValidationWithServiceProviderRule<MainRule, MainRule.ContextModel>
    {
        ...
        /// </summary>
        public class ContextModel : ContextModelBase<OrganizationUpdateRequest>
        {
            public ContextModel(OrganizationUpdateRequest parent, IRule rule) : base(parent, rule)
            {
            ...
            public OrganizationUpdateRequest Request => Parent;
