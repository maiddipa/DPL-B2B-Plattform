...
namespace Dpl.B2b.BusinessLogic.Rules.LoadingLocation.Update
{
    public class MainRule : BaseValidationWithServiceProviderRule<MainRule, MainRule.ContextModel>
    {
        ...
        /// </summary>
        public class ContextModel : ContextModelBase<LoadingLocationsUpdateRequest>
        {
            public ContextModel(LoadingLocationsUpdateRequest parent, IRule rule) : base(parent, rule)
            {
            ...
            public LoadingLocationsUpdateRequest Request => Parent;
        ...
        public class RulesBundle
        {
            ...
            {
                LoadingLocationResourceRule = new ResourceRule<Olma.LoadingLocation>(context.Request.Id, rule)
                    .IgnoreQueryFilter();
            }
        }
