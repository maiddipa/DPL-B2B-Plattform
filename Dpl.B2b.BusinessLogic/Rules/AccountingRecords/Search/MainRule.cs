...
namespace Dpl.B2b.BusinessLogic.Rules.AccountingRecords.Search
{
    public class MainRule : BaseValidationWithServiceProviderRule<MainRule, MainRule.ContextModel>
    {
        ...
        /// </summary>
        public class ContextModel : ContextModelBase<AccountingRecordsSearchRequest>
        {
            public ContextModel(AccountingRecordsSearchRequest parent, MainRule rule) : base(parent, rule)
            {
            ...
            public IPaginationResult<AccountingRecord> AccountingRecordPaginationResult
                => Rules.QueryAccountingRecord.Context.AccountingRecordPaginationResult;
        }
        ...
        public class RulesBundle
        {
            ...
            public QueryAccountingRecordRule QueryAccountingRecord { get; set; }
        }
