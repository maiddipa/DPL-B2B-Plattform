...
namespace Dpl.B2b.BusinessLogic.Rules.DivisionDocumentSetting.Create
{
    public class MainRule : BaseValidationWithServiceProviderRule<MainRule, MainRule.ContextModel>
    {
        ...
        /// </summary>
        public class ContextModel : ContextModelBase<CustomerDivisionDocumentSettingCreateRequest>
        {
            public ContextModel(CustomerDivisionDocumentSettingCreateRequest parent, IRule rule) : base(parent, rule)
            {
            ...
            public CustomerDivisionDocumentSettingCreateRequest Request => Parent;
        }
