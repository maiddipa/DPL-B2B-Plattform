...
namespace Dpl.B2b.BusinessLogic.Rules.CustomerDocumentSetting.Update
{
    public class MainRule : BaseValidationWithServiceProviderRule<MainRule, MainRule.ContextModel>
    {
        ...
        public class RulesBundle
        {
            ...
            {
                CustomerDocumentSettingResourceRule = new ResourceRule<Olma.CustomerDocumentSetting>(context.Request.Key, rule);
            }
        }
