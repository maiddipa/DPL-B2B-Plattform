...
namespace Dpl.B2b.BusinessLogic.Rules.CustomerDivision.Create
{
    public class MainRule : BaseValidationWithServiceProviderRule<MainRule, MainRule.ContextModel>
    {
        ...
        /// </summary>
        public class ContextModel : ContextModelBase<CustomerDivisionCreateRequest>
        {
            ...
            public CustomerDivisionCreateRequest Request => Parent;

            public ICollection<Olma.CustomerDivisionDocumentSetting> CustomerDivisionDocumentSettings =>
                Rules.DefaultDocumentSettingsRule.Context.CustomerDivisionDocumentSettings;
        }
        ...
        {
            public readonly DefaultDocumentSettingsRule DefaultDocumentSettingsRule;
