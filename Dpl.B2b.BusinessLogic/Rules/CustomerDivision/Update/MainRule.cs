...
namespace Dpl.B2b.BusinessLogic.Rules.CustomerDivision.Update
{
    public class MainRule : BaseValidationWithServiceProviderRule<MainRule, MainRule.ContextModel>
    {
        ...
        /// </summary>
        public class ContextModel : ContextModelBase<CustomerDivisionUpdateRequest>
        {
            public ContextModel(CustomerDivisionUpdateRequest parent, IRule rule) : base(parent, rule)
            {
            ...
            public CustomerDivisionUpdateRequest Request => Parent;
