...
namespace Dpl.B2b.BusinessLogic.Rules.Customer.Update
{
    public class MainRule : BaseValidationWithServiceProviderRule<MainRule, MainRule.ContextModel>
    {
        public MainRule(CustomerUpdateRequest request, IRule parentRule = null)
        {
            // Create Context
        ...
        /// </summary>
        public class ContextModel : ContextModelBase<CustomerUpdateRequest>
        {
            public ContextModel(CustomerUpdateRequest parent, IRule rule) : base(parent, rule)
            {
            ...
            public CustomerUpdateRequest Request => Parent;
